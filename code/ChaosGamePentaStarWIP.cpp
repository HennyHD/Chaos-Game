...
int main()
{
    ...
    double count;
    double randomVertex = 0;
    double randLast = randomVertex;
    double countRepeat = 0;
    double adj1;
    double adj2;
	...
	double count = points.size() - 1;
        if(points.size() > 0)
        {
            ...
            ///push back the newly generated coord.
            	...
            	count = points.size() - 1;
            	randomVertex = rand() % 5;
            	if (randLast == randomVertex) {  // repeat track
            		countRepeat++;
            	}
            	if (countRepeat == 2) {
            		adj1 = randLast-1;
            		...
            		while (randomVertex == adj1 || randomVertex == adj2) {
            			randomVertex = rand() % 5; //connot be adjacent to last point
            							//if last point used twice
            		}
            		countRepeat = 0;
            	}
